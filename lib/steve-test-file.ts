...
import { FindOptions, Filter } from 'https://deno.land/x/mongo@v0.29.4/mod.ts';
// import { Bson }
...
class Query {
  ...
  // public async find(allQueryObjects?: <Filter>, options?: FindOptions) {
  public async find (allQueryObjects?: Filter<Record<string, unknown>>, options?: FindOptions ) {
    try {
      const db = await this.connection.connect();
...
console.log('-----> Find test, options limit');
...
// query.find({ _id: '626967e7f588c0a4ba3b67af' });

// 626967e7f588c0a4ba3b67af
